            ...
            >
              <Card className="p-6 sm:p-8 relative bg-card/95 backdrop-blur-xl border border-border shadow-xl hover:shadow-2xl dark:bg-card/90 dark:border-white/[0.12] rounded-3xl overflow-hidden">
                ...
                <div className="py-6 space-y-4">
                  ...
                  {/* Architectural Achievements Grid */}
                  <div className="space-y-2.5 pt-2">
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {exp.achievements.map((achievement, idx) => (
                        <div
                          key={idx}
                          className="flex items-start gap-2.5 p-3.5 rounded-xl bg-muted/40 border border-border text-xs sm:text-sm text-foreground/90 dark:bg-white/[0.02] dark:border-white/[0.06] dark:text-zinc-300"
                        >
