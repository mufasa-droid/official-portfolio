    ...
    <section className="py-16 relative border-t border-border">
      <div className="container-custom">
        <motion.div
          ...
          className="glass-card rounded-3xl p-8 sm:p-10 border border-border relative overflow-hidden dark:border-white/[0.12]"
        >
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              <div className="flex items-center gap-2.5">
                <Badge variant="accent" className="font-mono">
                  <Flame className="h-3.5 w-3.5 mr-1 text-orange-500 dark:text-orange-400" />
                  ACTIVE FOCUS
                </Badge>
            ...
            <div className="lg:col-span-4 flex flex-col items-start lg:items-end justify-center gap-4">
              <div className="p-4 rounded-xl bg-muted/40 border border-border w-full max-w-xs space-y-2 dark:bg-white/[0.03] dark:border-white/[0.08]">
                <div className="flex items-center justify-between text-xs font-mono">
                  <span className="text-muted-foreground">STATUS</span>
                  <span className="text-emerald-600 dark:text-emerald-400 font-semibold">IN PROGRESS</span>
                </div>
                <div className="h-1.5 bg-muted rounded-full overflow-hidden dark:bg-white/[0.06]">
                  <div className="h-full bg-gradient-to-r from-primary to-blue-500 rounded-full w-[80%]" />
                </div>
              </div>
