...
export function Projects() {
  ...
  const others = projects.filter(p => !(p as any).featured)
                ...
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-between">
                    <div>
                      ...
                      <h3 className="text-3xl font-bold mb-4">{(featured as any).title}</h3>
                      <p className="text-muted-foreground mb-6">
                        {(featured as any).problem}
                      </p>
                      ...
                      <div className="mb-8 p-4 bg-white/5 rounded-lg">
                        ...
                        <p className="text-lg font-semibold text-primary">
                          {(featured as any).impact.metric}
                        </p>
                      </div>

                      {/* Tech */}
                      <div className="flex flex-wrap gap-2 mb-6">
                        {(featured as any).tech.slice(0, 4).map((t: string) => (
                          <span
                            key={t}
              ...
              <Link href={`/projects/${(project as any).slug}`}>
                <div className="glass rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300 group cursor-pointer h-full flex flex-col">
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <h3 className="text-xl font-bold mb-2">{(project as any).title}</h3>
